...
val vv =  oldest([(~4,2,3),(2,2,3),(5,2,3),(~3,2,3)])
val tests = [
	(*FUN 1 TEST  *)
	...
	is_older((2011,11,31), (2011,11,31)) = false,
	is_older((~2,~5,31), (1,~9,31)) = true,
	is_older((2045,3,4), (2006,5,3)) = false,
	is_older((1,2,98) ,(1,2,98) ) = false,
	(*FUN 2 TEST  *)
	...
	oldest([(1900, 12,1), (1940,12,22)]) = SOME (1900,12,1), oldest([(2000, 1,12), (2000,2,12)]) = SOME (2000,1,12),
	oldest([(2000, 2,13), (2000,2,12)]) = SOME (2000,2,12),
	oldest([(2009, 5,30), (2100,1,15), (1998, 11,16)]) = SOME (1998,11,16),
